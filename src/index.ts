...
// let jsActions: grammar.StorymaticActionDict<Node> = {
//   _terminal() {
...
//     return makeNode`export ${block.js()}`;
//   },
//   Statement_export_variable(_0, _1, expr, _2) {
...
//     if (flags.typescript) {
//       return makeNode`let ${assignable.js()}: ${type.js()} = ${expr.js()}`;
//     } else {
//       return makeNode`/** @type {${type.js()}} */ let ${assignable.js()} = ${expr.js()}`;
//     }
//   },
//   unitNumber(num, unit) {
...
//     if (type && flags.typescript) {
//       return makeNode`${assignable.js()}: ${type.js()} = ${expr.js()}`;
//     } else if (type) {
//       return makeNode`/** @type {${type.js()}} */ ${assignable.js()} = ${expr.js()}`;
//     } else return makeNode`${assignable.js()} = ${expr.js()}`;
//   },
//   whitespace(_) {
//     return createNode(" ");
//   },
...
// semantics.addOperation<Node>("js", jsActions);

// type SMNode = Node;

let actions: grammar.StorymaticActionDict<ts.Node> = {};

semantics.addOperation<ts.Node>("ts", actions);
