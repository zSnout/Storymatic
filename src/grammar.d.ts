...
export interface StorymaticActionDict<T> extends ActionDict<T> {
  ...
  NonCallMemberAccessExp_member_access?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode, arg2: NonterminalNode) => T;
  NonCallMemberAccessExp_optional_chaining_member_access?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode, arg2: NonterminalNode) => T;
  NonCallMemberAccessExp_symbol_access?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode, arg2: NonterminalNode) => T;
  NonCallMemberAccessExp_optional_chaining_symbol_access?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode, arg2: NonterminalNode) => T;
  NonCallMemberAccessExp_computed_member_access?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode, arg2: Node, arg3: TerminalNode) => T;
  NonCallMemberAccessExp_optional_chaining_computed_member_access?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode, arg2: TerminalNode, arg3: Node, arg4: TerminalNode) => T;
  NonCallMemberAccessExp_tagged_template_literal?: (this: NonterminalNode, arg0: Node, arg1: NonterminalNode, arg2: NonterminalNode) => T;
  NonCallMemberAccessExp_non_null_assertion?: (this: NonterminalNode, arg0: Node, arg1: TerminalNode) => T;
  NonCallMemberAccessExp_as_expression?: (this: NonterminalNode, arg0: Node, arg1: NonterminalNode, arg2: TerminalNode, arg3: NonterminalNode, arg4: NonterminalNode) => T;
  NonCallMemberAccessExp_class_creation_symbolic?: (this: NonterminalNode, arg0: TerminalNode, arg1: NonterminalNode, arg2: NonterminalNode, arg3: NonterminalNode, arg4: TerminalNode, arg5: NonterminalNode, arg6: TerminalNode) => T;
  NonCallMemberAccessExp_class_creation_no_args?: (this: NonterminalNode, arg0: TerminalNode, arg1: NonterminalNode, arg2: NonterminalNode) => T;
  NonCallMemberAccessExp?: (this: NonterminalNode, arg0: NonterminalNode) => T;
